...
var feed = new Instafeed({
		...
		template: '<a href="{{link}}" target="_blank"><div class="nailthumb-container square-thumb"><img src="{{image}}" /></div><div class="likes"><p><i class="large red heart icon"></i> {{likes}}<br><br>{{location}}</p></div>',
});
